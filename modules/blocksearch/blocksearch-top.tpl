...
<div id="search_block_top" class="col-lg-2 col-xs-5 col-sm-3 col-md-2 pull-right">
	<a  class="groupe-btn dropdown hidden-md hidden-lg" title="{l s='Search' mod='blockuserinfo'}" href="#"><span class="fa fa-search"></span></a>
	<form method="get" action="{$link->getPageLink('search')|escape:'html'}" id="searchbox" class="row groupe">
		<input type="hidden" name="controller" value="search" />
		<input type="hidden" name="orderby" value="position" />
		<input type="hidden" name="orderway" value="desc" />	
