...
<div class="wlp_bought">
    <div class="clearfix wlp_bought_list products-item row">
        {foreach from=$products item=product name=i}
            <div id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="address product_block col-sm-4 col-xs-12 {if ($smarty.foreach.i.index + 1) % 3 == 1}clearfix{/if}">
