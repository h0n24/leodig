...
<form class="std form-horizontal" id="compare_shipping_form" method="post" action="#" >
	<fieldset id="compare_shipping">
		<h3>{l s='Estimate the cost of shipping & taxes.' mod='carriercompare'}</h3>
		<div class="form-group">
			<label class="control-label col-xs-2" for="id_country">{l s='Country' mod='carriercompare'}</label>
			<div class="col-xs-6">
		...
		<div id="states" style="display: none;" class="form-group">
			<label class="control-label col-xs-2" for="id_state">{l s='State' mod='carriercompare'}</label>
			<div class="col-xs-6">
		...
		<div class="form-group">
			<label class="control-label col-xs-2" for="zipcode">{l s='Zip Code' mod='carriercompare'}</label>
			<div class="col-xs-6">
				<input class="form-control" type="text" name="zipcode" id="zipcode" value="{$zipcode|escape:'htmlall':'UTF-8'}"/> <br/> ({l s='Needed for certain carriers.' mod='carriercompare'})
			</div>			
		</div>
