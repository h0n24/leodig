...
<div class=" carousel slide" id="leotab-{$datas.id_leomanagewidgets}-{$tabname}carousel">
	...
	<a class="carousel-control left" href="#leotab-{$datas.id_leomanagewidgets}-{$tabname}carousel" data-slide="prev">&lsaquo;</a>
	<a class="carousel-control right" href="#leotab-{$datas.id_leomanagewidgets}-{$tabname}carousel" data-slide="next">&rsaquo;</a>
	{/if}
				...
				<div class="{if $datas.ncolumn == 5}leo-md-5{else}col-sm-{$datas.scolumn}{/if} col-sm-4 col-xs-12 product_block ajax_block_product">
					<div class="product-container clearfix">
						...
						<div class="right_block">
							...
							{/if}
							*}
							<a  href="#" id="wishlist_button{$product.id_product}" class="btn-tooltip button wishlist-compare fa fa-heart" onclick="LeoWishlistCart('wishlist_block_list', 'add', '{$product.id_product}', $('#idCombination').val(), 1 ); return false;" title="{l s='Add to wishlist' mod='leomanagewidgets'}"></a>
							<a class="quick-view btn-tooltip button wishlist-compare fa fa-arrows-alt" title="{l s='Quick View' mod='leomanagewidgets'}" href="{if $product.link|strpos:"?"}{$product.link|cat:"&content_only=1"|escape:'htmlall':'UTF-8'}{else}{$product.link|cat:"?content_only=1"|escape:'htmlall':'UTF-8'}{/if}"></a>
						</div>								
					</div>
				</div>				
