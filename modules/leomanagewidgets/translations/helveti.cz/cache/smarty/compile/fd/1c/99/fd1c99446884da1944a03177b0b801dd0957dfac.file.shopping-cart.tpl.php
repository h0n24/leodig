<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 19:03:43
         compiled from "/srv/www/helveti/helveti.cz/themes/leodig/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:55847882656671b7f15e811-62971114%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fd1c99446884da1944a03177b0b801dd0957dfac' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/themes/leodig/shopping-cart.tpl',
      1 => 1447285587,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '55847882656671b7f15e811-62971114',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56671b7f924276_32633688',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56671b7f924276_32633688')) {function content_56671b7f924276_32633688($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
	...
	<table id="cart_summary" class="std table-bordered">
		<thead>
			<tr>
				...
				<th class="cart_ref item"><?php echo smartyTranslate(array('s'=>'Dostupnost'),$_smarty_tpl);?>
</th>
				<th class="cart_unit item"><?php echo smartyTranslate(array('s'=>'Cena za kus'),$_smarty_tpl);?>
</th>
				<th class="cart_quantity item"><?php echo smartyTranslate(array('s'=>'Množství'),$_smarty_tpl);?>
</th>
...
<?php }?>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['product']->value['id_manufacturer']==10){?><?php $_smarty_tpl->tpl_vars['jeVN'] = new Smarty_variable(1, null, 0);?><?php }?>
		<?php } ?>
		...
		<tfoot>
			...
			<tr class="cart_total_price">
				<td colspan="4" id="cart_voucher" class="cart_voucher">
					<div id="kosik_dopravy" class="kosik_moznosti">
						<div>Možnosti dopravy</div>
						<div id="ceskaposta" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-c-posta.png" alt="Česká pošta" title="Česká pošta"></div>
						<div id="dpd" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-dpd.png" alt="DPD" title="DPD"></div>
						<div id="ppl" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-ppl.png" alt="PPL" title="PPL"></div>
						<div id="ulozenka" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-ulozenka.png" alt="Uloženka" title="Uloženka"></div>
						<div id="osobni" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-osobne.png" alt="Osobní odběr" title="Osobní odběr"></div>
					</div>
					<div id="kosik_platby" class="kosik_moznosti">
						<div>Možnosti platby</div>
						<div id="hotovost" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-hotove.png" alt="Hotově" title="Hotově"></div>
						<div id="kartou" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-kartou.png" alt="Kartou" title="Kartou"></div>
						<div id="prevodem" class="ikonka_moznosti"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/kosik-prevodem.png" alt="Převodem" title="Převodem"></div>
					</div>
					<div id="doprava_platba_info">
						<span class="ikonka_i">i</span> Dopravu a platbu si <strong>můžete vybrat v 3.kroku objednávky.</strong>
					</div>
					<div id="kupon">
						<input type="checkbox" id="kupon_helper" name="kupon_helper" <?php if (isset($_smarty_tpl->tpl_vars['discount_name']->value)&&$_smarty_tpl->tpl_vars['discount_name']->value){?>checked<?php }?>><label for="kupon_helper">Mám slevový kupón nebo Sphere card<i class="fa fa-chevron-down"></i></label>
					</div>
...
<?php }?>" method="post" id="voucher" class="form-inline">
						<fieldset <?php if (!(isset($_smarty_tpl->tpl_vars['discount_name']->value)&&$_smarty_tpl->tpl_vars['discount_name']->value)){?>style="display:none"<?php }?>>
...
<?php }?>" />
						...
						<div class="form-group">
							<p class="submit"><input type="hidden" name="submitDiscount" /><input type="submit" name="submitAddDiscount" value="<?php echo smartyTranslate(array('s'=>'Vložit'),$_smarty_tpl);?>
" class="btn button" /></p>
						</div>
						</fieldset>
					</form>
...
<br />
				...
				<td colspan="3" class="price total_price_container" id="total_price_container">
					<div id="ceny_s_dph">ceny jsou uvedeny včetně DPH</div>
					<?php if ($_smarty_tpl->tpl_vars['shippingCost']->value>0){?>
					<div id="kosik_box_doprava">Doprava: <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['shippingCost']->value),$_smarty_tpl);?>
</div>
					<?php }else{ ?>
...
/helveti/cart-car.png" class="cart-car"> Doprava zdarma</div>
					<?php }?>
					<p class="celkem_kosik">celkem: <span class="cena_celkem"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price']->value),$_smarty_tpl);?>
</span></p>
				</td>
				<?php }else{ ?>
				<td colspan="3" class="price total_price_container" id="total_price_container">
					...
					<div id="kosik_box_doprava_zdarma"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
/helveti/cart-car.png" class="cart-car"> Doprava zdarma</div>
					<p class="celkem_kosik">celkem: <span class="cena_celkem"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayPrice'][0][0]->displayPriceSmarty(array('price'=>$_smarty_tpl->tpl_vars['total_price_without_tax']->value),$_smarty_tpl);?>
</span></p>
				</td>
				<?php }?>
			</tr>
...
">
				...
				<td class="cart_discount_name cart_description" colspan="2"><p class="s_title_block"><?php echo $_smarty_tpl->tpl_vars['discount']->value['name'];?>
</p></td>
				<td class="cart_discount_price cart_unit"><span class="price-discount price">
...
<?php }?>
				...
				<td class="cart_discount_delete cart_quantity">1</td>
				<td class="cart_discount_price cart_total">
...
<?php }?></span>
				...
				<td class="price_discount_del cart_delete">
...
"><i class="fa fa-times" alt="<?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
"></i></a><?php }?>
				</td>
			</tr>
		<?php } ?>
...
<?php }?>" class="button pull-right standard-checkout" title="<?php echo smartyTranslate(array('s'=>'Pokračovat v objednávce'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Pokračovat v objednávce'),$_smarty_tpl);?>
 <i class="fa fa-chevron-right"></i></a>
		<?php if (Configuration::get('PS_ALLOW_MULTISHIPPING')){?>
			<a href="<?php if ($_smarty_tpl->tpl_vars['back']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1&amp;back={$back}');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,'step=1');?>
<?php }?>&amp;multi-shipping=1" class="pull-right multishipping-button multishipping-checkout button" title="<?php echo smartyTranslate(array('s'=>'Pokračovat v objednávce'),$_smarty_tpl);?>
"><?php echo smartyTranslate(array('s'=>'Pokračovat v objednávce'),$_smarty_tpl);?>
 <i class="fa fa-chevron-right"></i></a>
		<?php }?>
	<?php }?>
