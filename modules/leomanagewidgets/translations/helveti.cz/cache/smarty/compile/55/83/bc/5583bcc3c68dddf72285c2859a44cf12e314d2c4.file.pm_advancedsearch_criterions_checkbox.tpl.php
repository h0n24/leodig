<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 18:52:55
         compiled from "/srv/www/helveti/helveti.cz/modules/pm_advancedsearch4/views/templates/hook/pm_advancedsearch_criterions_checkbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1972616913566718f7bd2549-10410100%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5583bcc3c68dddf72285c2859a44cf12e314d2c4' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/modules/pm_advancedsearch4/views/templates/hook/pm_advancedsearch_criterions_checkbox.tpl',
      1 => 1437582964,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1972616913566718f7bd2549-10410100',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_566718f7d2c6a7_99451494',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_566718f7d2c6a7_99451494')) {function content_566718f7d2c6a7_99451494($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
...
_0" clas="PM_ASLabelCheckbox"><?php echo smartyTranslate(array('s'=>'All','mod'=>'pm_advancedsearch4'),$_smarty_tpl);?>
</label>
...
][]" <?php if ($_smarty_tpl->tpl_vars['as_criterion_is_selected']->value){?>checked="checked"<?php }?> class="PM_ASCriterionCheckbox"<?php if (!$_smarty_tpl->tpl_vars['criterion']->value['nb_product']){?> disabled="disabled"<?php }?> /> 
...
<?php }else{ ?>javascript:void(0)<?php }?>">
							<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['criterion']->value['value'], 'htmlall', 'UTF-8');?>
<?php if ($_smarty_tpl->tpl_vars['as_search']->value['display_nb_result_criterion']){?> (<span class="cislo_v_zavorce"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['criterion']->value['nb_product'], 'htmlall', 'UTF-8');?>
</span>)<?php }?>
						</a>
					</label>
					<?php if (version_compare(@constant('_PS_VERSION_'),'1.6.0.0','>=')){?>
