<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 18:53:11
         compiled from "/srv/www/helveti/helveti.cz/themes/leodig/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:118804499456671907c28138-23336695%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ce59b63c5f39b64cebea01a7d63df91c6d980be1' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/themes/leodig/product-list.tpl',
      1 => 1447142773,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '118804499456671907c28138-23336695',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56671907e9dcd2_48807148',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56671907e9dcd2_48807148')) {function content_56671907e9dcd2_48807148($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
...
?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction'])){?>
			...
			<?php }elseif($_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction_type']=='amount'){?>
				<?php $_smarty_tpl->tpl_vars['proReduce'] = new Smarty_variable(round((1-($_smarty_tpl->tpl_vars['product']->value['price']/($_smarty_tpl->tpl_vars['product']->value['price']+$_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction'])))*100), null, 0);?>
			<?php }?>
		<?php }?>
			...
			<div class="product-container clearfix">
				<div class="center_block">				
					<div class="block-vyhoda-productlist">
						...
						<?php $_smarty_tpl->tpl_vars['nova_zobrazena_dlazdice'] = new Smarty_variable(rand(1,14), null, 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?> <span class="skladem"><?php echo smartyTranslate(array('s'=>'Skladem'),$_smarty_tpl);?>
							...
							<?php if ($_smarty_tpl->tpl_vars['product']->value['condition']=="used"){?> <span class="bazar"><?php echo smartyTranslate(array('s'=>'Bazar'),$_smarty_tpl);?>
</span><?php }?>
