<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 20:29:39
         compiled from "/srv/www/helveti/helveti.cz/themes/leodig/order-carrier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:76032901156672fa3143dc0-06501282%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60227b03e2d0bcdb6bb926a4955129921f14a7c9' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/themes/leodig/order-carrier.tpl',
      1 => 1415214153,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '76032901156672fa3143dc0-06501282',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56672fa3387232_97699774',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56672fa3387232_97699774')) {function content_56672fa3387232_97699774($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php if (!$_smarty_tpl->tpl_vars['opc']->value){?>
	<h1><?php echo smartyTranslate(array('s'=>'Choose your delivery method'),$_smarty_tpl);?>
</h1>
<?php }else{ ?>
...
?>
				<div class="delivery_option <?php if (($_smarty_tpl->tpl_vars['option']->index%2)){?>alternate_<?php }?>item form-group clearfix">
...
"/>
								...
								<td class="delivery_option_icko">
									<?php $_smarty_tpl->tpl_vars['dodani'] = new Smarty_variable(Carrier::dodaniDoprava($_smarty_tpl->tpl_vars['cart']->value->id,$_smarty_tpl->tpl_vars['carrier']->value['instance']->name), null, 0);?>
									<?php if ($_smarty_tpl->tpl_vars['dodani']->value){?>
										<?php echo $_smarty_tpl->tpl_vars['dodani']->value;?>
								...
								<td class="delivery_option_price">
									<?php if ($_smarty_tpl->tpl_vars['option']->value['total_price_with_tax']&&(!isset($_smarty_tpl->tpl_vars['free_shipping']->value)||(isset($_smarty_tpl->tpl_vars['free_shipping']->value)&&!$_smarty_tpl->tpl_vars['free_shipping']->value))){?>
										...
										<?php }?>
									<?php }else{ ?>
										<div class="free-shipping"><?php echo smartyTranslate(array('s'=>'Free'),$_smarty_tpl);?>
</div>
									<?php }?>
								</td>
								<td class="delivery_option_icko">
									<span class="btn-tooltip doprava_ikonka_i ikonka_i" data-html="true" data-placement="right" data-original-title="<?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['carrier']->value['instance']->name;?>
<?php $_tmp1=ob_get_clean();?><?php echo Carrier::informaceDoprava($_tmp1);?>
">i</span>
								</td>
							</tr>
						</table>
						<table class="col-sm-12 delivery_option_carrier <?php if (isset($_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value])&&$_smarty_tpl->tpl_vars['delivery_option']->value[$_smarty_tpl->tpl_vars['id_address']->value]==$_smarty_tpl->tpl_vars['key']->value){?>selected<?php }?> <?php if ($_smarty_tpl->tpl_vars['option']->value['unique_carrier']){?>not-displayable<?php }?>">
							<?php  $_smarty_tpl->tpl_vars['carrier'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['carrier']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['option']->value['carrier_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['carrier']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['carrier']->iteration=0;
...
<?php if (!$_smarty_tpl->tpl_vars['product']->last){?>, <?php }else{ ?>)<?php }?><?php }?><?php } ?>
			...
			<input type="hidden" id="ulozenka_id_custom" value="<?php echo Configuration::get('ULOZENKA_CARRIER_ID');?>
"/>
...
" class="zpet-do-obchodu"><i class="fa fa-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Zpět na dodací údaje'),$_smarty_tpl);?>
</a>
			<?php }else{ ?>
...
" class="zpet-do-obchodu"><i class="fa fa-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Zpět na dodací údaje'),$_smarty_tpl);?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['virtual_cart']->value)&&$_smarty_tpl->tpl_vars['virtual_cart']->value||(isset($_smarty_tpl->tpl_vars['delivery_option_list']->value)&&!empty($_smarty_tpl->tpl_vars['delivery_option_list']->value))){?>
			...
			<input type="submit" name="processCarrier" value="<?php echo smartyTranslate(array('s'=>'Vyberte způsob platby'),$_smarty_tpl);?>
