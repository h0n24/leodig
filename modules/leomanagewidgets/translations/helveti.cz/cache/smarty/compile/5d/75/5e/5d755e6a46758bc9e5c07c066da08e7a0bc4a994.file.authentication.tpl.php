<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 19:08:33
         compiled from "/srv/www/helveti/helveti.cz/themes/leodig/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:102444463856671ca11090c2-91682880%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5d755e6a46758bc9e5c07c066da08e7a0bc4a994' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/themes/leodig/authentication.tpl',
      1 => 1430833401,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '102444463856671ca11090c2-91682880',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56671ca198b943_31346332',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56671ca198b943_31346332')) {function content_56671ca198b943_31346332($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php if (isset($_smarty_tpl->tpl_vars['one_phone_at_least']->value)&&$_smarty_tpl->tpl_vars['one_phone_at_least']->value){?> <sup>*</sup><?php }?></label>
					<div class="col-sm-4">
						<input type="text" class="form-control text" name="phone_mobile" autocomplete="off" id="phone_mobile" value="<?php if (isset($_POST['phone_mobile'])){?><?php echo $_POST['phone_mobile'];?>
<?php }?>" />
					</div>
 ...
 <sup>*</sup></label>
					<div class="col-sm-4">
						<input type="text" class="form-control text" id="firstname" name="firstname" autocomplete="off" onblur="$('#customer_firstname').val($(this).val());" value="<?php if (isset($_POST['firstname'])){?><?php echo $_POST['firstname'];?>
<?php }?>" />
...
<?php }?>" />
 ...
 <sup>*</sup></label>
					<div class="col-sm-4">
						<input type="text" class="form-control text" id="lastname" name="lastname" autocomplete="off" onblur="$('#customer_lastname').val($(this).val());" value="<?php if (isset($_POST['lastname'])){?><?php echo $_POST['lastname'];?>
<?php }?>" />
...
<?php }?>" />
 ...
 <sup>*</sup></label>
							<div class="col-sm-4">
								<input type="text" class="form-control text" name="address1" autocomplete="off" id="address1" value="<?php if (isset($_POST['address1'])){?><?php echo $_POST['address1'];?>
<?php }?>" />
							</div>
						</div>
 ...
 <sup>*</sup></label>
							<div class="col-sm-4">
								<input type="text" class="form-control text" name="city" autocomplete="off" id="city" value="<?php if (isset($_POST['city'])){?><?php echo $_POST['city'];?>
<?php }?>" />
							</div>
						</div>
 ...
 <sup>*</sup></label>
							<div class="col-sm-3">
								<input type="text" class="form-control text" name="postcode" autocomplete="off" id="postcode" value="<?php if (isset($_POST['postcode'])){?><?php echo $_POST['postcode'];?>
					...
					<div class="col-sm-8">
						<div class="checkbox">
							<label for="invoice_address">
								...
								<?php echo smartyTranslate(array('s'=>'Fakturovat na jinou adresu'),$_smarty_tpl);?>
</label>
						</div>
					</div>
				</div>
