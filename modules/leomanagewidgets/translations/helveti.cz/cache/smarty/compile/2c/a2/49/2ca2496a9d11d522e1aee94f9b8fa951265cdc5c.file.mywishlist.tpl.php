<?php /* Smarty version Smarty-3.1.14, created on 2015-12-13 02:36:54
         compiled from "/srv/www/helveti/helveti.cz/themes/leodig/modules/blockwishlist/mywishlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:347405546566ccbb69c0216-15057730%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ca2496a9d11d522e1aee94f9b8fa951265cdc5c' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/themes/leodig/modules/blockwishlist/mywishlist.tpl',
      1 => 1412020998,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '347405546566ccbb69c0216-15057730',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_566ccbb6adc1a3_41359688',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_566ccbb6adc1a3_41359688')) {function content_566ccbb6adc1a3_41359688($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<h1><?php echo smartyTranslate(array('s'=>'My wishlists','mod'=>'blockwishlist'),$_smarty_tpl);?>
</h1>
...
" />
					<label class="control-label col-sm-3" for="name"><?php echo smartyTranslate(array('s'=>'Name','mod'=>'blockwishlist'),$_smarty_tpl);?>
</label>
					<div class="col-sm-9">
						<input type="text" id="name" name="name" class="inputTxt form-control" value="<?php if (isset($_POST['name'])&&count($_smarty_tpl->tpl_vars['errors']->value)>0){?><?php echo smarty_modifier_escape($_POST['name'], 'htmlall', 'UTF-8');?>
<?php }?>" />
					</div>
...
" class="zpet-do-obchodu"><span class="fa fa-chevron-left"></span><?php echo smartyTranslate(array('s'=>'Back to Your Account','mod'=>'blockwishlist'),$_smarty_tpl);?>
</a></li>
		<li class="f_right"><a href="<?php echo $_smarty_tpl->tpl_vars['base_dir']->value;?>
" class="zpet-do-obchodu"><?php echo smartyTranslate(array('s'=>'Home','mod'=>'blockwishlist'),$_smarty_tpl);?>
