<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 19:03:43
         compiled from "/srv/www/helveti/helveti.cz/themes/leodig/shopping-cart-product-line.tpl" */ ?>
<?php /*%%SmartyHeaderCode:136941590456671b7fb69a21-06296828%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '24a67bf78373729d0dff5629d50098977d9051d9' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/themes/leodig/shopping-cart-product-line.tpl',
      1 => 1416173049,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '136941590456671b7fb69a21-06296828',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56671b7fe79e78_32093363',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56671b7fe79e78_32093363')) {function content_56671b7fe79e78_32093363($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
...
"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'kosik_default'), ENT_QUOTES, 'UTF-8', true);?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value['name'], 'htmlall', 'UTF-8');?>
	...
	<td class="cart_ref"><?php ob_start();?><?php echo Product::skladovost($_smarty_tpl->tpl_vars['product']->value['id_product'],"skladem");?>
...
<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['gift'])){?>_gift<?php }?>">
			...
			<?php }else{ ?>
				<?php if (isset($_smarty_tpl->tpl_vars['product']->value['is_discounted'])&&$_smarty_tpl->tpl_vars['product']->value['is_discounted']){?>
					<span style="text-decoration:line-through;" class="old-price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value['price_without_specific_price']),$_smarty_tpl);?>
</span><br />
				<?php }?>
...
<?php $_tmp4=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"add=1&amp;id_product=".$_tmp2."&amp;ipa=".$_tmp3."&amp;id_address_delivery=".$_tmp4."&amp;token=".((string)$_smarty_tpl->tpl_vars['token_cart']->value)), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/quantity_up2.gif" alt="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" width="14" height="14" /></a><br />
...
">
					<img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/quantity_down2.gif" alt="<?php echo smartyTranslate(array('s'=>'Subtract'),$_smarty_tpl);?>
" width="14" height="14" />
				</a>
				<?php }else{ ?>
