<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 18:53:12
         compiled from "/srv/www/helveti/helveti.cz/themes/leodig/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1048787397566719087c3b79-04714010%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8f8d7666cc6deef503d78b6e8116db75aa908fcd' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/themes/leodig/pagination.tpl',
      1 => 1411202642,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1048787397566719087c3b79-04714010',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56671908acf5d1_87194870',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56671908acf5d1_87194870')) {function content_56671908acf5d1_87194870($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
...
">&laquo;<span class="pagination-slova"> <?php echo smartyTranslate(array('s'=>'Předchozí'),$_smarty_tpl);?>
</a></li>
		<?php }else{ ?>
			<li id="pagination_previous<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)){?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
<?php }?>" class="disabled pagination_previous"><span>&laquo;<span class="pagination-slova"> <?php echo smartyTranslate(array('s'=>'Předchozí'),$_smarty_tpl);?>
</span></li>
		<?php }?>
...
"><span class="pagination-slova"><?php echo smartyTranslate(array('s'=>'Další'),$_smarty_tpl);?>
</span> &raquo;</a></li>
		<?php }else{ ?>
			<li id="pagination_next<?php if (isset($_smarty_tpl->tpl_vars['paginationId']->value)){?>_<?php echo $_smarty_tpl->tpl_vars['paginationId']->value;?>
<?php }?>" class="disabled pagination_next"><span><span class="pagination-slova"><?php echo smartyTranslate(array('s'=>'Další'),$_smarty_tpl);?>
</span> &raquo;</span></li>
		<?php }?>
		</ul>
	<?php }?>
...
<?php }?>" method="get" class="form-inline pagination pull-right">
...
" />
				...
				<?php } ?>
			<?php }?>
			<input type="submit" class="button_mini btn btn-sm" value="<?php echo smartyTranslate(array('s'=>'OK'),$_smarty_tpl);?>
" />
		</form>
	<?php }?>
	</div>
