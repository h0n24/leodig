<?php /* Smarty version Smarty-3.1.14, created on 2015-12-08 20:34:34
         compiled from "/srv/www/helveti/helveti.cz/modules/cashondelivery/views/templates/front/validation.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1519899061566730ca6f1597-50569426%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33a3eca51e50c83e580967fc57fa8da87a7b18e5' => 
    array (
      0 => '/srv/www/helveti/helveti.cz/modules/cashondelivery/views/templates/front/validation.tpl',
      1 => 1447285865,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1519899061566730ca6f1597-50569426',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_566730ca81ce30_51526924',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_566730ca81ce30_51526924')) {function content_566730ca81ce30_51526924($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/helveti.cz/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>Skladem<?php }else{ ?>do 14 dní<?php }?></td>
			<td class="cart_unit">
				<span class="price">
				<?php if (isset($_smarty_tpl->tpl_vars['product_cart']->value['is_discounted'])&&$_smarty_tpl->tpl_vars['product_cart']->value['is_discounted']){?>
...
helveti/ico-validation-platba.png" alt="Ikonka platby">
			...
			<td colspan="4" class="cart_description">
				Způsob platby: <strong>Hotově (při převzetí, dobírka)</strong>
			</td>
			<td class="cart_total">
				ZDARMA
			</td>
...
" method="post">
	...
	<div class="row">
		<input type="submit" value="<?php echo smartyTranslate(array('s'=>'Odeslat objednávku','mod'=>'cashondelivery'),$_smarty_tpl);?>
...
?step=3" class="zpet-do-obchodu"><i class="fa fa-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Zpět na výběr platby','mod'=>'cashondelivery'),$_smarty_tpl);?>
</a>
		</div>
