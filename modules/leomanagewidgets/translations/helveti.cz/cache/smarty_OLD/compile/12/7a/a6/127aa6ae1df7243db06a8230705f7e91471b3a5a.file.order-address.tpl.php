<?php /* Smarty version Smarty-3.1.14, created on 2014-11-10 19:40:59
         compiled from "/srv/www/helveti/themes/leodig/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:614223183546106bbaea753-87512989%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '127aa6ae1df7243db06a8230705f7e91471b3a5a' => 
    array (
      0 => '/srv/www/helveti/themes/leodig/order-address.tpl',
      1 => 1415214672,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '614223183546106bbaea753-87512989',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_546106bc11f261_82356840',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_546106bc11f261_82356840')) {function content_546106bc11f261_82356840($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/srv/www/helveti/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/tools/smarty/plugins/modifier.escape.php';
?>
...
<div class="kosik-container kosik-container-adress">
...
<h1><?php echo smartyTranslate(array('s'=>'Kontrola adres'),$_smarty_tpl);?>
</h2>
...
<?php }?>
	<div class="addresses clearfix">
		<div  class="address_delivery select form-group clearfix">
			<label class="control-label" for="id_address_delivery"><?php if ($_smarty_tpl->tpl_vars['cart']->value->isVirtualCart()){?><?php echo smartyTranslate(array('s'=>'Choose a billing address:'),$_smarty_tpl);?>
...
" <?php if ($_smarty_tpl->tpl_vars['address']->value['id_address']==$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery){?>selected="selected"<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['address']->value['alias'], 'htmlall', 'UTF-8');?>
		...
		<div id="address_invoice_form" class="select" <?php if ($_smarty_tpl->tpl_vars['cart']->value->id_address_invoice==$_smarty_tpl->tpl_vars['cart']->value->id_address_delivery){?>style="display: none;"<?php }?>>

		<?php if (count($_smarty_tpl->tpl_vars['addresses']->value)>1){?>
			<label for="id_address_invoice" class="strong control-label"><?php echo smartyTranslate(array('s'=>'Choose a billing address:'),$_smarty_tpl);?>
</label>
			<div class="col-sm-4">
...
" class="zpet-do-obchodu"><i class="fa fa-chevron-left"></i> <?php echo smartyTranslate(array('s'=>'Zpět na dodací údaje'),$_smarty_tpl);?>
		...
		<input type="submit" name="processAddress" value="<?php echo smartyTranslate(array('s'=>'Vyberte způsob dopravy'),$_smarty_tpl);?>
" class="button standard-checkout pull-right" />
	</p>
</form>
<?php }else{ ?>
</div>
