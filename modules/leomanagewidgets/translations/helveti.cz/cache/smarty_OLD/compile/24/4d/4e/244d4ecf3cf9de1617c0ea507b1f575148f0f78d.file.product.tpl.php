<?php /* Smarty version Smarty-3.1.14, created on 2014-11-10 19:35:21
         compiled from "/srv/www/helveti/themes/leodig/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:104807730854610569d3bdf7-87471781%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '244d4ecf3cf9de1617c0ea507b1f575148f0f78d' => 
    array (
      0 => '/srv/www/helveti/themes/leodig/product.tpl',
      1 => 1415277052,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '104807730854610569d3bdf7-87471781',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_546105797ea627_61357006',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_546105797ea627_61357006')) {function content_546105797ea627_61357006($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/srv/www/helveti/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_date_format')) include '/srv/www/helveti/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_counter')) include '/srv/www/helveti/tools/smarty/plugins/function.counter.php';
?>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?> <span class="product_tag skladem"><?php echo smartyTranslate(array('s'=>'Skladem'),$_smarty_tpl);?>
</span><br /><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='percentage'){?>
							<span class="product_tag hot"><?php echo smartyTranslate(array('s'=>'Reduced price!'),$_smarty_tpl);?>
...
%</span><br />
 ...
 -<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value-floatval($_smarty_tpl->tpl_vars['productPrice']->value)),$_smarty_tpl);?>
						...
						<?php }?>
						<?php if (Product::jeNovinka($_smarty_tpl->tpl_vars['product']->value->id)){?><span class="product_tag new"><?php echo smartyTranslate(array('s'=>'Novinka'),$_smarty_tpl);?>
</span><br /><?php }?>
						<?php if ($_smarty_tpl->tpl_vars['product']->value->top200){?>
							<span class="product_tag nejprodavanejsi"><?php echo smartyTranslate(array('s'=>'Nejprodavanější'),$_smarty_tpl);?>
</span><br />
						<?php }?>
						<?php if ($_smarty_tpl->tpl_vars['product']->value->condition=="used"){?>
							<span class="product_tag bazar"><?php echo smartyTranslate(array('s'=>'Bazar'),$_smarty_tpl);?>
</span><br />
						<?php }?>
				</div>
...
"><?php echo $_smarty_tpl->tpl_vars['cat']->value['name'];?>
	...
	<?php $_smarty_tpl->tpl_vars['pocet_hvezd'] = new Smarty_variable(Product::pocetHeurekaHvezd($_smarty_tpl->tpl_vars['product']->value->id,'hvezdy'), null, 0);?> 	
		<div class="produkt-dalsi-info">
			<div class="box_prodejce"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
