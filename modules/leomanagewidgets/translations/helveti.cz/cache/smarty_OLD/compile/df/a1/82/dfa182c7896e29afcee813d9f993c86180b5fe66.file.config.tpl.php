<?php /* Smarty version Smarty-3.1.14, created on 2014-11-10 19:41:25
         compiled from "/srv/www/helveti/modules/noxaltrolog/views/templates/admin/config.tpl" */ ?>
<?php /*%%SmartyHeaderCode:517887150546106d5014fa3-20804008%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dfa182c7896e29afcee813d9f993c86180b5fe66' => 
    array (
      0 => '/srv/www/helveti/modules/noxaltrolog/views/templates/admin/config.tpl',
      1 => 1415228926,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '517887150546106d5014fa3-20804008',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_546106d5210df1_77189061',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_546106d5210df1_77189061')) {function content_546106d5210df1_77189061($_smarty_tpl) {?>
	...
	<table style="width:100%;border-top:1px solid #aaa">
		<tr>
			...
			<?php if (count($_smarty_tpl->tpl_vars['logitem']->value['log'][3])>0){?>
				<p  class="mini_nadpis"><strong>Rozdílné ceny:</strong></p>
...
" target="_blank"><?php }?>
					...
					<?php } ?>
					<td style="text-align:center;<?php if ($_smarty_tpl->tpl_vars['druhacena']->value-$_smarty_tpl->tpl_vars['prvnicena']->value<0){?>color:red;<?php }elseif($_smarty_tpl->tpl_vars['druhacena']->value-$_smarty_tpl->tpl_vars['prvnicena']->value>0){?>color:green<?php }?>"><?php echo $_smarty_tpl->tpl_vars['druhacena']->value-$_smarty_tpl->tpl_vars['prvnicena']->value;?>
</td> 
					</tr>
				<?php } ?>
				</table>
