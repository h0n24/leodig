				...
				<div class="comment_informations">
					<div class="comment_author">
						...
						<div class="comment_author_infos">
							...
							<em>{$comment.date_add|date_format:"j. n. Y"}</em>
						</div>
					</div>
		...
		<form id="id_new_comment_form" action="#">
			...
			<div class="product row clearfix">
				<div class="col-md-5 col-xs-12">
					<img class="img-responsive" src="{$link->getImageLink($product->link_rewrite, $productcomment_cover, 'home_default')|escape:'html'}"  alt="{$product->name|escape:html:'UTF-8'}" />
				</div>
			...
			<div class="new_comment_form_content">
				...
				<div id="new_comment_form_footer">
					...
					<p class="required pull-left"><sup>*</sup> {l s='Required fields' mod='productcomments'}</p>
					<p class="pull-right">
						<button class="button" id="submitNewMessage" name="submitMessage" type="submit">{l s='Send' mod='productcomments'}</button>&nbsp;
