	...
	<div class="panel-body">
		...
		<div class="col-sm-6 col-xs-12">
			<ul class="address {if $smarty.foreach.myLoop.last}last_item{elseif $smarty.foreach.myLoop.first}first_item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{else}item{/if}">
				...
				{/foreach}
				<li class="address_update"><a href="{$link->getPageLink('address', true, null, "id_address={$address.object.id|intval}")|escape:'html'}" title="{l s='Update'}">{l s='Update'} <i class="fa fa-chevron-right"></i></a></li>
				<li class="address_delete"><a href="{$link->getPageLink('address', true, null, "id_address={$address.object.id|intval}&delete")|escape:'html'}" onclick="return confirm('{l s='Are you sure?' js=1}');" title="{l s='Delete'}">{l s='Delete'}<i class="fa fa-times"></i></a></li>
			</ul>
		</div>
		{/foreach}
		</div>
...
<ul class="footer_links clearfix cart_navigation">
	<li class="f_left"><a href="{$link->getPageLink('my-account', true)|escape:'html'}" class="zpet-do-obchodu"><span class="fa fa-chevron-left"></span>{l s='Back to your account'}</a></li>
	<li class="f_right"><a href="{$base_dir}" class="zpet-do-obchodu">{l s='Home'} <span class="fa fa-chevron-right"></span></a></li>
</ul>
