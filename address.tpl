	...
	<div class="panel panel-default">
		...
		{/if}
			...
			<div class="required text form-group" id="adress_alias">
				<label class="control-label col-sm-4" for="alias">{l s='Název adresy'} <sup>*</sup></label>
				<div class="col-sm-6">
					...
					<span class="form_info">{l s='Přiřaďte této adrese název pro budoucí použití'}</span>
				</div>
			</div>
