...
{else}
	...
	<form action="{$link->getPageLink('identity', true)|escape:'html'}" method="post" class="std kosik-container">
...
<ul class="footer_links clearfix cart_navigation">
	<li class="pull-left"><a href="{$link->getPageLink('my-account', true)|escape:'html'}" class="zpet-do-obchodu"><span class="fa fa-chevron-left"></span> {l s='Back to your account'}</a></li>
	<li class="pull-right"><a href="{$base_dir}" class="zpet-do-obchodu">{l s='Home'} <span class="fa fa-chevron-right"></span></a></li>
</ul>
