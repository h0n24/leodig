		...
		<div class="block">
			<div id="manufacturers_list">
				...
				{foreach from=$manufacturers item=manufacturer name=manufacturers}
					{if $manufacturer@iteration%$limitcolumn==1}
							...
							<div class="box-content">
								<div class="left_side clearfix">
									...
									{if $manufacturer.nb_products > 0}<a href="{$link->getmanufacturerLink($manufacturer.id_manufacturer, $manufacturer.link_rewrite)|escape:'htmlall':'UTF-8'}" title="{$manufacturer.name|escape:'htmlall':'UTF-8'}" class="lnk_img">{/if}
										<img class="img-responsive" src="{$img_manu_dir}{$manufacturer.image|escape:'htmlall':'UTF-8'}-large_default.jpg" alt="" />
					...
					{if $manufacturer@iteration%$limitcolumn==0||$smarty.foreach.manufacturers.last}
						</div>
					{/if}
				{/foreach}
			</div>
