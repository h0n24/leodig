...
// <![CDATA[
	...
	function buildAddressBlock(id_address, address_type, dest_comp)
	{
		...
		li_content['update'] = '<a href="{$link->getPageLink('address', true, NULL, "id_address")|addslashes}'+id_address+'&amp;back={$back_order_page}?step=1{if $back}&mod={$back}{/if}" title="{l s='Update' js=1}">{l s='Update' js=1} <i class="fa fa-chevron-right"></i></a>';
...
{/if}
	<div class="addresses clearfix">
		...
		{if $addresses|@count > 1}
			...
			<div class="clearfix"></div>
			{else}
				<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1&select_address=1{if $back}&mod={$back}{/if}")|escape:'html'}" title="{l s='Add'}">{l s='Add a new address'} <i class="fa fa-chevron-right"></i></a>
			{/if}
		</div>
		...
		<p class="address_add submit">
			<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{if $back}&mod={$back}{/if}")|escape:'html'}" title="{l s='Add'}">{l s='Add a new address'}  <i class="fa fa-chevron-right"></i></a>
		</p>
		{if !$opc}
